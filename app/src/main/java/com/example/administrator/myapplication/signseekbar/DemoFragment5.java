...
public class DemoFragment5 extends Fragment {
    ...
    private void test4(View view) {
        com.example.administrator.myapplication.signseekbar.seekbar.SignSeekBar signSeekBar = (com.example.administrator.myapplication.signseekbar.seekbar.SignSeekBar) view.findViewById(R.id.demo_5_seek_bar_4);
        signSeekBar.getConfigBuilder()
                .max(100)
                .min(0)
                .setUnit("%")
                .build();
        signSeekBar.setProgress(15*100/100);
